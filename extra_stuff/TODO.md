...
Traceback (most recent call last):
  ...
  File "/home/sound/bass-sentry/remote-node/remote-sender.py", line 149, in sender
    telemetry = TelemetrySender(topic_suffix="remote_node")
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/sound/bass-sentry/remote-node/telemetry_sender.py", line 183, in __init__
    self.handler.start()
  File "/home/sound/bass-sentry/remote-node/telemetry_sender.py", line 106, in start
    self.client.connect(self.broker_address)
  File "/home/sound/.venv/lib/python3.11/site-packages/paho/mqtt/client.py", line 914, in connect
    return self.reconnect()
           ^^^^^^^^^^^^^^^^
  File "/home/sound/.venv/lib/python3.11/site-packages/paho/mqtt/client.py", line 1044, in reconnect
    sock = self._create_socket_connection()
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/sound/.venv/lib/python3.11/site-packages/paho/mqtt/client.py", line 3685, in _create_socket_connection
...
^C__main__ - INFO - Received signal to terminate. - Line 70
