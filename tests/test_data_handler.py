...
from data_handler import ChunkToCCStream, DataHandler
...
class TestChunkToCCStream:
    ...
    def test_correlation_with_identical_signals(self):
        ...
        assert len(result) == 1
        remote_id, db, tau, corr_coef, confidence, data_quality = result[0]
    ...
    def test_rcc_method(self):
        ...
        db, tau, r = self.processor.rcc(sig1, sig2, 44100)
